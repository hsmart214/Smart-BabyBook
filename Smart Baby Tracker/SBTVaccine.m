...
+(NSDictionary *)vaccinesByTradeName
{
    ...
    if (!allVaccs){
        allVaccs = @{
                     ...
                     @"Pentacel (HiB)":[[SBTVaccine alloc] initWithName:@"Pentacel HiB" displayNames:@[@"HiB"] manufacturer:Sanofi andComponents:@[@(SBTComponentFDA_Approved), @(SBTComponentPRP_T)]],
                     @"Pentacel (DTaP-IPV)":[[SBTVaccine alloc] initWithName:@"Pentacel DTaP-IPV" displayNames:@[@"DTaP", @"IPV"] manufacturer:Sanofi andComponents:@[@(SBTComponentFDA_Approved), @(SBTComponentDTaP), @(SBTComponentIPV)]],
                     ...
                     @"Prevnar":[[SBTVaccine alloc] initWithName:@"Prevnar" displayNames:@[@"PCV7"] manufacturer:Wyeth andComponents:@[@(SBTComponentFDA_Approved), @(SBTComponentPCV7)]],
                     @"Prevnar 13":[[SBTVaccine alloc] initWithName:@"Prevnar 13" displayNames:@[@"PCV13"] manufacturer:Wyeth andComponents:@[@(SBTComponentFDA_Approved), @(SBTComponentPCV13)]],
