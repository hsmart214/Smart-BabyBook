...
- (void)testHepBRegular2Dose_NotDueYet
{
    ...
    [enc replaceVaccines:[NSSet setWithArray:@[hepB]]];
    [self.baby addEncounter:enc];
    SBTVaccineDoseStatus status = (SBTVaccineDoseStatus)[[self.sched vaccinationStatusForVaccineComponent:SBTComponentHepB forBaby:self.baby][SBTVaccineSeriesStatusKey] integerValue];
...
// tests whether it correctly ignores the live vaccine 20 days prior to dose 3
{
    ...
    [enc replaceVaccines:[NSSet setWithArray:@[hepB]]];
    [self.toddler addEncounter:enc];
    SBTVaccineDoseStatus status = (SBTVaccineDoseStatus)[[self.sched vaccinationStatusForVaccineComponent:SBTComponentHepB forBaby:self.toddler][SBTVaccineSeriesStatusKey] integerValue];
    XCTAssertTrue(status == SBTVaccinationUTD , @"Incorrect calculation of Hep B status with two valid doses, not due yet.");
}
...
- (void)testHepB4DosesLikeUCSD
{
    ...
    [enc replaceVaccines:[NSSet setWithArray:@[hepB]]];
    [self.baby2 addEncounter:enc];
    SBTVaccineDoseStatus status = (SBTVaccineDoseStatus)[[self.sched vaccinationStatusForVaccineComponent:SBTComponentHepB forBaby:self.baby2][SBTVaccineSeriesStatusKey] integerValue];
